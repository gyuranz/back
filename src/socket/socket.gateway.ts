...
export class SocketGateway implements OnGatewayConnection, OnGatewayDisconnect {
  ...
  handleDisconnect(socket: Socket) {
    const user = SocketGateway.connectedUsers.find((user) => user.socketId === socket.id);
  ...
  initializeConnectionHandler(data: any, socket: Socket) {
  ...
  createNewRoomHandler(data: any, socket: Socket) {
  ...
  joinRoomHandler(data: any, socket: Socket) {
    ...
    socket.to(roomId).emit("room-update", { connectedUsers: room.connectedUsers });
  }

  @SubscribeMessage('conn-signal')
  signalingHandler(data: any, socket: Socket) {
